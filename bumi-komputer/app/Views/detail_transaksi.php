      ...
      <div class="card shadow-sm">
        <div class="card-body">
          <table class="table table-bordered mb-0">
            ...
            <tr>
              <th class="td-label">ID Pelanggan</th>
              <td><?= htmlentities($data['id_pelanggan']); ?></td>
            </tr>

            <tr>
              <th class="td-label">Kode Barang</th>
              <td><?= htmlentities($data['kode_barang']); ?></td>
            </tr>
              ...
              <td>
                ...
                elseif (!empty($detailBarang) && is_array($detailBarang)):
                  foreach ($detailBarang as $idx => $b):
                    ...
                    <?php if ($idx !== array_key_last($detailBarang)): ?>
                      <hr><?php endif; ?>
                    <?php
                  endforeach;
                else:
            ...
            <tr>
              <th class="td-label">Tanggal Transaksi</th>
