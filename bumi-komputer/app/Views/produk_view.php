...
<body>
  ...
  <div class="sidebar">
    ...
    <a href="index.php?action=produk" class="active">
  ...
  <nav class="navbar top-navbar navbar-dark px-3">
    ...
    <div class="content">
        ...
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"s integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz"
